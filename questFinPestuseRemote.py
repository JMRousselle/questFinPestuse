...
from questFinPestuseGui import GuiDecision
...
class RemoteQFP(IRemote):
    ...
    def remote_newperiod(self, period):
        ...
        if self.currentperiod <= 1:
            del self.histo[:]
            self.histo_vars = texts_QFP.get_histo_vars()
            self.histo.append(texts_QFP.get_histo_head())
    ...
    def remote_display_summary(self, period_content):
        ...
        if self._le2mclt.simulation:
            ...
            ecran_recap = GuiRecapitulatif(
                ...
                texts_QFP.get_text_summary(period_content))
            ecran_recap.show()
            return defered
