...
from questFinPestuseGui import DConfigure
...
class Serveur(object):
    def __init__(self, le2mserv):
        ...
        actions[le2mtrans(u"Display payoffs")] = \
            ...
            display_payoffs_onserver("questFinPestuse")
        self._le2mserv.gestionnaire_graphique.add_topartmenu(
            u"questFinPestuse", actions)
    ...
    def _demarrer(self):
        ...
        if not self._le2mserv.gestionnaire_graphique.question(
                        le2mtrans(u"Start") + u" questFinPestuse?"):
            return

        # init part ============================================================
        yield (self._le2mserv.gestionnaire_experience.init_part(
            "questFinPestuse", "PartieQFP",
            "RemoteQFP", pms))
